...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', async function (event) {
        ...
        try {
            ...
            const certElement =
                document.getElementById('certNumber');
            ...
            const studentName =
                studentElement ? studentElement.value.trim() : '';

            const courseName =
                courseElement ? courseElement.value.trim() : '';

            const completionDate =
                dateElement ? dateElement.value : '';

            let certNumber =
                certElement ? certElement.value.trim() : '';

            const directorName =
                directorElement ? directorElement.value.trim() : '';

            const template =
                templateElement ? templateElement.value : 'gold';
